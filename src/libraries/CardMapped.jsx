    ...
    <div id="container" className="big-container">
      ...
      >
            ...
            <button onClick={(event)=>{{toggleTooltip(false);handleClick(event)}}} className="tooltip-button">
								Dive Deeper <span style={{display:'flex',alignItems:'center',marginLeft:'5px'}}><svg className="dive-deeper-arrow" width="0.8vw" height="1.3vh" viewBox="0 0 8 13" fill="none" xmlns="http://www.w3.org/2000/svg">
